    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Cportal.deviceinfo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('connected_interface', models.CharField(blank=True, max_length=200, null=True)),
                ('customer_location', models.CharField(blank=True, max_length=100, null=True)),
                ('customer_Bandwidth', models.DecimalField(decimal_places=2, max_digits=10)),
                ('customer_unit', models.CharField(choices=[('Mbps', 'Mbps'), ('Gbps', 'Gbps')], max_length=20, null=True)),
                ('connected_device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cportal.deviceinfo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.CharField(choices=[('IIG', 'IIG'), ('ISP', 'ISP'), ('NIX', 'NIX')], max_length=100, null=True)),
